...
class EqualizerService {
  static const MethodChannel _channel = MethodChannel('com.example.playa_clean/equalizer');
  
  static Future<void> initializeEqualizer(int audioSessionId) async {
    if (!Platform.isAndroid) return;
    await _channel.invokeMethod('initializeEqualizer', {'audioSessionId': audioSessionId});
  }
